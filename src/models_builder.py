...
class LogisticRegressionSurrogate:
    ...
    def plot_interpretation(self, features, max_features=10):
        ...
        plt.xlabel('Coefficient Value')
        plt.title('Positive Feature Importance from Logistic Regression Surrogate Model')
        plt.show()
        ...
        plt.xlabel('Coefficient Value')
        plt.title('Negative Feature Importance from Logistic Regression Surrogate Model')
        plt.show()
