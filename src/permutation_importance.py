...
def plot_permutation_importance(model, X, y, metric='accuracy', title="Permutation Importance", S=10):
    """
    ...
    relative_perm_importance = perm_importance.importances_mean / np.sum(perm_importance.importances_mean)
